    ...
    <div class="card">
        <div class="card-body">
            <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal"
                ...
                Crear Colaborador<i class="ti ti-plus ms-2"></i>
            </button>
                                ...
                                <td class="{{ $colaborador->estado === 'off' ? 'bg-light-danger' : '' }}">
                                    <div class="d-flex gap-1 justify-content-center">
                                        <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                            data-bs-target="#modalEditUser_{{ $colaborador->colaborador_id }}"> <i
                                                class="ti ti-pencil"></i>
                                        </button>

                                        <!--Modal edit -->
                                        <div class="modal fade" id="modalEditUser_{{ $colaborador->colaborador_id }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-dm"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form
                                                            action="{{ route('colaborador.update', $colaborador->colaborador_id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="rol" id="rol"
                                                                    ...
                                                                    <option value="{{ $colaborador->rol }}" selected
                                                                        readonly>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="nombre" class="form-label">Seleccione el
                                                                    tipo
                                                                    colaborador</label>
                                                                <select name="tipo_colaborador" id="tipo_colaborador"
                                                                    class="form-control">
                                                                    <option value="{{ $colaborador->tipo_colaborador }}"
                                                                        selected>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="nombre" class="form-label">Selecione el
                                                                    horario</label>
                                                                <select name="horario_id" id="tipo_colaborador"
                                                                    class="form-control">
                                                                    <option value="{{ $colaborador->id_horario }}"
                                                                        selected>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="nombre" class="form-label">Tipo de
                                                                    contrato</label>
                                                                <select name="tipo_contrato" id="tipo_contrato"
                                                                    class="form-control">
                                                                    <option value="{{ $colaborador->tipo_contrato }}"
                                                                        selected>
                                        ...
                                        <a href="{{ route('colaboradores.show', $colaborador->colaborador_id) }}"
                                            class="btn btn-dark"> <i class="ti ti-eye"></i>
                                        </a>
